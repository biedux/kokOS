...
public class Scheduler {
    ...
    */
    ...
    void TimeSlice(PCB pcb) { // nie zabezpieczylem ze kolejka bedzie sie rownala 0
      ...
      pcb.setTimeSlice(timeslice_int);
       ...
       /* if(Heap.size()==0){
            ...
            if (pcb.getTimeSlice() < min_granularity)
    ...
    void VirtualTime(PCB pcb) // zakładam,ze przy zmianie stanu na aktywny w baseTime wpiszemy czas, podczas ktorego process dostał procesor
    {
        ...
        double NewVirtualTime = 1 * weight + VirtualTime;
