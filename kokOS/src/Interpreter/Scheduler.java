...
public class Scheduler {
    ...
    */
    ...
    long min_granularity = 5; // minimalny czas, na jaki proces moze otryzmać procesor
    long period = 60; // okres, ustalany z gory, czas w jakim powinien każdy proces otrzymać procesor
